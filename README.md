Доработана структура проекта, оптимизированы картинки, дописан CSS, подготовлен pop up для входа и регистрации с плавной анимацией, реализован адаптив 1440px, 1024px, реализована смешение элементов, а также появление мобильного меню.
